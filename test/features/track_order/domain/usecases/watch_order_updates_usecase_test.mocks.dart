...
// in flower_app/test/features/track_order/domain/usecases/watch_order_updates_usecase_test.dart.
...
class MockOrderRepository extends _i1.Mock implements _i2.OrderRepository {
  ...
  @override
  _i3.Future<_i4.Order?> getOrderById({
  ...
  @override
  _i3.Stream<_i4.Order?> watchOrderById({
    required String? userId,
    required String? orderId,
  }) =>
      (super.noSuchMethod(
