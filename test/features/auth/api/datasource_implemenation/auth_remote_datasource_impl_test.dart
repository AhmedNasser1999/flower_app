...
group('Test login_models response in Login Function', ()  {
  test('Success State for Login Response', ()async {
    //Arrange
    final loginRequest = LoginRequest(email: "mohamedyasser192023@gmail.com", password: "Mohamedyasser@2003");
    ...
    when(mockAuthApiClient.login(loginRequest)).thenAnswer((_) async =>  loginResponse);
  ...
  test('Failure State for Login Response (returns error AuthResponse)', () async {
    // Arrange
  ...
  group('AuthRemoteDatasourceImpl - forget password', () {
    test('forgetPassword should call AuthApiClient.forgetPassword and return AuthResponse', () async {
      // Arrange
    ...
    test('resetPassword should call AuthApiClient.resetPassword and return AuthResponse', () async {
    ...
    test('verifyResetPassword should call AuthApiClient.verifyResetCode and return AuthResponse', () async {
  ...
  group('AuthRemoteDatasourceImpl Error Cases', () {
    test('forgetPassword should return AuthResponse.error when API fails', () async {
      final request = ForgetPasswordRequestModel(email: 'test@example.com');
    ...
    test('resetPassword should return AuthResponse.error when API fails', () async {
      final request = ResetPasswordRequestModel(
        email: 'test@example.com',
        newPassword: 'Pass123!',
      );
    ...
    test('verifyResetPassword should return AuthResponse.error when API fails', () async {
      final request = VerifyCodeRequestModel(resetCode: '1234');
