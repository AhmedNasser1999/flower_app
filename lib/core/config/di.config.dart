...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i701.OrderRemoteDataSource>(
        () => _i841.OrderRemoteDataSourceImpl(gh<_i277.ApiClient>()));
    gh.factory<_i747.AddressRemoteDataSource>(() =>
        _i670.AddressRemoteDataSourceImpl(
            addressApiClient: gh<_i277.ApiClient>()));
    ...
    gh.lazySingleton<_i43.CheckoutDatasource>(
        () => _i843.CheckoutDataSourceImpl(apiClient: gh<_i277.ApiClient>()));
    gh.lazySingleton<_i1026.CartRemoteDataSource>(
        () => _i948.CartRemoteDataSourceImpl(gh<_i277.ApiClient>()));
    ...
    gh.factory<_i341.ResetPasswordCubit>(
        () => _i341.ResetPasswordCubit(gh<_i277.ApiClient>()));
    gh.lazySingleton<_i904.GetCategoriesRemoteDataSource>(
        () => _i315.GetCategoriesRemoteDataSourceImpl(gh<_i277.ApiClient>()));
